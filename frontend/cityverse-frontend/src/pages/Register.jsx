        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-12">
            ...
            <p className="text-zinc-500 mt-5 text-lg leading-relaxed">
              Join Urban Nexus and access next-generation
      ...
      >
        ...
        <div className="relative z-10 max-w-xl px-12">
          ...
          <p className="mt-8 text-lg text-zinc-500 leading-relaxed">
            Create your Urban Nexus account and unlock
            AI-powered monitoring, emergency response,
            infrastructure intelligence, and live city analytics.
          </p>
